 ...
 * @date 2023/3/28
 */
public interface CustomizedDataPermissionHandler extends MultiDataPermissionHandler {
     ...
     */
    void insertParameter(Insert insertStmt, MappedStatement mappedStatement, BoundSql boundSql);
