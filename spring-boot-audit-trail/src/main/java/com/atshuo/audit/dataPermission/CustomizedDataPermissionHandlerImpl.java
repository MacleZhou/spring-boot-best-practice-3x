...
import com.atshuo.audit.dataPermission.dummy.SecurityUtils;
import com.atshuo.audit.dataPermission.dummy.StringPool;
import com.atshuo.audit.dataPermission.dummy.SysUser;
import com.atshuo.audit.dataPermission.dummy.ScopeField;
import com.atshuo.audit.dataPermission.dummy.UserOverreachException;
import com.atshuo.audit.dataPermission.dummy.PluginUtils;
 ...
 */
@Slf4j
public class CustomizedDataPermissionHandlerImpl implements CustomizedDataPermissionHandler {
    ...
    @Override
    public void insertParameter(Insert insertStmt, MappedStatement mappedStatement, BoundSql boundSql) {
