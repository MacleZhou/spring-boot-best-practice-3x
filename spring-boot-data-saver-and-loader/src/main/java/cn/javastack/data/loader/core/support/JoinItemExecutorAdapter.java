...
public class JoinItemExecutorAdapter<SOURCE_DATA, JOIN_KEY, JOIN_DATA, RESULT>
    ...
    private final Function<Object, Object> joinDataLoader;
    ...
    @Override
    protected Object getJoinDataByJoinKey(Object joinKey) {
    ...
    @Override
    protected void onFound(SOURCE_DATA data, Object joinResults) {
