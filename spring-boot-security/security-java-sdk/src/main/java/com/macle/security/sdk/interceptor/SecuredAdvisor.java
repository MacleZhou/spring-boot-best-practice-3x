...
public class SecuredAdvisor extends AbstractPointcutAdvisor {
    private final Advice advice;
    private final Pointcut pointcut;

    public SecuredAdvisor(Class<? extends Annotation> annotation, MethodInterceptor methodInterceptor) {
        this.advice = methodInterceptor;
        this.pointcut = buildPointcut(annotation);
    }

    public SecuredAdvisor(String expression, MethodInterceptor methodInterceptor) {
        this.advice = methodInterceptor;
