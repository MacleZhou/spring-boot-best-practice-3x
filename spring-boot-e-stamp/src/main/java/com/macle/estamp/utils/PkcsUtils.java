...
public class PkcsUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileOutputStream outPutStream = new FileOutputStream("spring-boot-e-stamp/img/keystore.p12");
        outPutStream.write(result.get("keyStoreData"));
        outPutStream.close();
        FileOutputStream fos = new FileOutputStream(new File("spring-boot-e-stamp/img/keystore.cer"));
