package com.macle.estamp.utils;
...
public class SignPdf2 {
    ...
    public static void main(String[] args) throws Exception {
        byte[] fileData = sign("123456", "spring-boot-e-stamp/img/keystore.p12",
                "spring-boot-e-stamp/img/待签名.pdf",//
                "spring-boot-e-stamp/img/公章1.png", 100, 290);
        FileOutputStream f = new FileOutputStream(new File("spring-boot-e-stamp/img/已签名.pdf"));
        f.write(fileData);
        f.close();
    }
}