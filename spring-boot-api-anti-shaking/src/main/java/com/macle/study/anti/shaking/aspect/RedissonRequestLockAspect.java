package com.macle.study.anti.shaking.aspect;

import java.lang.reflect.Method;

import com.macle.study.anti.shaking.annotation.RequestLock;
import com.macle.study.anti.shaking.constant.BizException;
import com.macle.study.anti.shaking.constant.ResponseCodeEnum;
...
public class RedissonRequestLockAspect {
    ...
    @Around("execution(public * * (..)) && @annotation(com.macle.study.anti.shaking.annotation.RequestLock)")
